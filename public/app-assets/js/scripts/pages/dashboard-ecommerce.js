...
$(window).on('load', function () {
  ...
  var $earningsChart1 = document.querySelector('#deplesi-chart');
  var $earningsChart2 = document.querySelector('#pakan-chart');
  var $earningsChart3 = document.querySelector('#ovk-chart');
  ...
  var earningsChartOptions1;
  var earningsChartOptions2;
  var earningsChartOptions3;
  ...
  earningsChart1 = new ApexCharts($earningsChart1, earningsChartOptions1);
  earningsChart1.render();
  
  earningsChartOptions2 = {
    chart: {
      type: 'donut',
      height: 120,
      toolbar: {
  ...
  earningsChart2 = new ApexCharts($earningsChart2, earningsChartOptions2);
  earningsChart2.render();

  earningsChartOptions3 = {
    chart: {
      type: 'donut',
      height: 120,
      toolbar: {
  ...
  earningsChart3 = new ApexCharts($earningsChart3, earningsChartOptions3);
  earningsChart3.render();
  ...
  revenueReportChartOptions = {
    ...
    colors: ['#76A8D8', window.colors.solid.warning],
    series: [
      {
        name: 'Earning',
  ...
  budgetChartOptions = {
    ...
    colors: ['#76A8D8', $budgetStrokeColor2],
    series: [
      {
