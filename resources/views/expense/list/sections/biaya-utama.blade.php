    ...
    <table id="expense-repeater-1" class="table table-bordered">
        ...
        <tbody data-repeater-list="expense_items">
            <tr data-repeater-item>
                ...
                <td><input name="price" type="text" class="form-control numeral-mask text-right" value="0" disabled></td>
                <td><input name="total_price" type="text" class="form-control numeral-mask text-right total-amount-all-farms" value="0" placeholder="0"></td>
