                    ...
                    <div class="row row-cols-2 row-cols-md-4">
                        ...
                        <div class="col-md-2 mt-1">
                            ...
                            <select name="namaPelanggan" id="namaPelanggan" class="form-control" disabled>
                                ...
                                <option value="2" selected="selected">Abd. Muisss</option>
                            </select>
                        </div>
                        <!-- Tanggal Penjualan -->
                        <div class="col-md-2 mt-1">
                            <label for="tanggalPenjualan" class="form-label">Tanggal Penjualan*</label>
                            <input id="tanggalPenjualan" name="tanggalPenjualan" type="date" class="form-control" disabled>
                        </div>
                        <!-- Tanggal Retur -->
                        <div class="col-md-2 mt-1">
                            <label for="tanggalRetur" class="form-label">Tanggal Retur*</label>
                            <input id="tanggalRetur" name="tanggalRetur" type="date" class="form-control" required>
                        </div>
                        <!-- Status -->
                        <div class="col-md-2 mt-1">
                        ...
                        <table id="datatable" class="table table-bordered table-striped w-100">
                            ...
                            <tbody data-repeater-list="farms">
                                <tr class="text-center" data-repeater-item>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" value="7,000" disabled>
                                    </td>
                                    <td>
