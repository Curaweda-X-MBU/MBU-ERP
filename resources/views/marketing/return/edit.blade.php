...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ route('marketing.return.edit', $data->marketing_id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="col-12 mt-1">
                        <a href="{{ route('marketing.return.detail', $data->marketing_id) }}" class="btn btn-outline-warning waves-effect">Batal</a>
