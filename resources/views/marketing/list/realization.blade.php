            ...
            <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ route('marketing.list.add') }}" enctype="multipart/form-data">
                    ...
                    <div class="row row-cols-2 row-cols-md-4">
                        ...
                        <!-- Tanggal Realisasi -->
                        <div class="col-md-2 mt-1">
                            <label for="tanggalPenjualan" class="form-label">Tanggal Realisasi</label>
                        ...
                        <table id="datatable" class="table table-bordered table-striped w-100">
                            ...
                            <tbody data-repeater-list="farms">
                                <tr class="text-center" data-repeater-item>
                                    ...
                                    <td>
                                        <select class="form-control">
                                            <option value="1" selected="selected">Satuan</option>
                                        </select>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" placeholder="Waktu Keluar Kandang">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <select class="form-control">
                                            <option value="1" selected="selected">Driver</option>
                                        </select>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm btn-icon btn-danger" data-repeater-delete type="button" title="Hapus Kandang">
