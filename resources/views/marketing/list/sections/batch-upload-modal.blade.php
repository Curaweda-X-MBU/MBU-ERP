            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <form id="formPaymentCsv" class="col-12 mb-2" action="{{ route('marketing.list.payment.batch') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="col-12 d-flex flex-column flex-lg-row mb-1" style="gap: 1em;">
                                <a role="button" class="btn btn-success w-100" href="{{ asset('assets/files/payment_batch_upload_template.csv') }}"><i data-feather="download"></i>&nbsp;Download Template</a>
