            ...
            <table id="datatable" class="table" style="margin: 0 0 !important;">
                <thead>
                    <tr class="text-center">
                        ...
                        <th rowspan="2" style="vertical-align: middle">Rp/Ekor</th>
                    </tr>
                    <tr class="text-center">
                        <th>QTY</th>
                        <th>Harga Satuan</th>
...
<script>
    ...
    function generateBudgetTable(data) {
        ...
        titleRow.innerHTML = `<td colspan="9" class="pt-1"><h4>Budget</h4></td>`
            ...
            if (item.subkategori && item.subkategori.length > 0) {
                item.subkategori.forEach((sub) => {
                    ...
                    subRow.innerHTML = `
                        ...
                        <td>Rp <span>${sub.rpPerEkor.toLocaleString("id-ID")}</span></td>
                    `;
