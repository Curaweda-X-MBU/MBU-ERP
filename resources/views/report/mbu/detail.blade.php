    ...
    <div class="col-12">
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link rounded" id="nav-sapronak-tab" data-toggle="tab" data-target="#nav-sapronak" type="button" role="tab" aria-controls="nav-sapronak" aria-selected="true">Sapronak</button>
                ...
                <button class="nav-link rounded active" id="nav-penjualan-tab" data-toggle="tab" data-target="#nav-penjualan" type="button" role="tab" aria-controls="nav-penjualan" aria-selected="false">Penjualan</button>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade " id="nav-sapronak" role="tabpanel" aria-labelledby="nav-sapronak-tab">
            ...
            <div class="tab-pane fade show active" id="nav-penjualan" role="tabpanel" aria-labelledby="nav-penjualan-tab">
