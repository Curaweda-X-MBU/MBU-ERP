                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{ route('user-management.permission.edit', $data->permission_id) }}">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-sm-9 offset-sm-3">
                                                ...
                                                <a href="{{ route('user-management.permission.index') }}" class="btn btn-outline-warning waves-effect">Batal</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
