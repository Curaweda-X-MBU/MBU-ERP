...
@section('content')
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{ route('user-management.user.add') }}" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" id="npk" class="{{$errors->has('npk')?'is-invalid':''}} form-control" name="npk" placeholder="NPK" value="{{ old('npk') }}">
                                                        @if ($errors->has('npk'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <select name="role_id" id="role_id" class="form-control">
                                                            <option disabled selected>Pilih Unit Bisnis terlebih dahulu</option>
                                                            @if(old('role_id') && old('role_name'))
                                                                <option value="{{ old('role_id') }}" selected="selected">{{ old('role_name') }}</option>
                                                            @endif
                                                        </select>
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            var oldValueRole = "{{ old('role_id') }}";
                            if (oldValueRole) {
                                var oldNameRole = "{{ old('role_name') }}";
                                if (oldNameRole) {
