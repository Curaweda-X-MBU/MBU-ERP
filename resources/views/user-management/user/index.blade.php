                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="float-right">
                                        <a href="{{ route('user-management.user.add') }}" type="button" class="btn btn-outline-primary waves-effect">Tambah Baru</a>
                                    </div>
                                    {{-- @endif --}}
                                </div>
                                <div class="card-body">
                                                            ...
                                                            <td>
                                                                <div class="dropdown dropleft">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" href="{{ route('user-management.user.edit', $item->user_id) }}">
                                                                            <i data-feather="edit-2" class="mr-50"></i>
                                                                            <span>Edit</span>
                                                                        </a>
                                                                        <a class="dropdown-item text-danger" href="javascript:void(0);" data-id="{{ $item->user_id }}" data-toggle="modal" data-target="#delete">
                    ...
                    <div class="modal fade text-left" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                <form method="post" action="{{ route('user-management.user.delete', 'test') }}">
                                {{csrf_field()}}
