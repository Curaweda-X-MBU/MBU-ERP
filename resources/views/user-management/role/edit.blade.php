                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{ route('user-management.role.edit', $data->role_id) }}">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" id="name" class="{{$errors->has('name')?'is-invalid':''}} form-control" name="name" placeholder="Nama Role" value="{{ $data->name }}">
                                                        @if ($errors->has('name'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" name="all_area" id="customCheck1" {{ $data->all_area===1?'checked':'' }}>
                                                            <label class="custom-control-label" for="customCheck1">Semua Area</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox mt-1">
                                                            <input type="checkbox" class="custom-control-input" name="all_location" id="customCheck2" {{ $data->all_location===1?'checked':'' }}>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        ...
                                                        if (!function_exists('generateHtml')) {
                                                            function generateHtml($tree, $oldModul, $prefix = '') {
                                                                $html = '<ul class="tree">';
                                                                ...
                                                                foreach ($tree as $key => $subtree) {
                                                                    ...
                                                                    if (!empty($subtree)) {
                                                                        ...
                                                                        $html .= generateHtml($subtree, $oldModul, $currentName);
                                                                    } else {
