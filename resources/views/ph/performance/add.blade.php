...
@section('content')
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal invoice-repeater" id="formAudit" method="post" action="{{ route('ph.performance.add') }}">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select name="hatchery" id="hatchery" class="form-control">
                                                                    ...
                                                                    @if(old('hatchery'))
                                                                        <option value="{{ old('hatchery') }}" selected="selected">{{ old('hatchery') }}</option>
                                                                    @endif
                                                                </select>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" class="form-control flatpickr-basic" name="chick_in_date" placeholder="Tanggal Chick In" value="{{ old('chick_in_date')?date('d-M-Y', strtotime(old('chick_in_date'))):'' }}" />
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="number" id="death" class="{{$errors->has('death')?'is-invalid':''}} form-control" name="death" placeholder="Jumlah Mati" value="{{ old('death') }}">
                                                                @if ($errors->has('death'))
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="number" id="culling" class="{{$errors->has('culling')?'is-invalid':''}} form-control" name="culling" placeholder="Jumlah Culling" value="{{ old('culling') }}">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="number" id="bw" class="{{$errors->has('bw')?'is-invalid':''}} form-control" name="bw" placeholder="Body Weight (BW)" value="{{ old('bw') }}">
                                                                @if ($errors->has('bw'))
                                            ...
                                            <div class="col-12 mt-2">
                                                {{-- <div class="row"> --}}
                                                    <center>
                                                        ...
                                                        <a href="{{ route('ph.performance.index') }}" class="btn btn-outline-warning waves-effect">Batal</a>
                                                    </center>
                                                {{-- </div> --}}
                                            </div>
                                        </div>
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            var oldValueHatchery = "{{ old('hatchery') }}";
                            if (oldValueHatchery) {
                                var oldNameHatchery = "{{ old('hatchery') }}";
                                if (oldNameHatchery) {
