...
<script>
    ...
    const dataKandang = [
        { name: "Pandeglang 1", status: "aktif", link: "/report/lti/detail/kandang" },
        { name: "Pandeglang 2", status: "tidak aktif", link: "/report/lti/detail/kandang" },
        { name: "Pandeglang 3", status: "aktif", link: "/report/lti/detail/kandang" },
        { name: "Pandeglang 4", status: "tidak aktif", link: "/report/lti/detail/kandang" },
        { name: "Pandeglang 5", status: "aktif", link: "/report/lti/detail/kandang" }
    ];
