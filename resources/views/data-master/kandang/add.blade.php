...
@section('content')
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" id="formAudit" method="post" action="{{ route('data-master.kandang.add') }}">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" name="name" id="name" class="{{$errors->has('name')?'is-invalid':''}} form-control" placeholder="Nama kandang" value="{{old('name')}}">
                                                        @if ($errors->has('name'))
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="number" name="capacity" id="capacity" class="{{$errors->has('capacity')?'is-invalid':''}} form-control" placeholder="Kapasitas kandang" value="{{old('capacity')}}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <select name="pic" id="pic" class="form-control">
                                                            @if(old('pic') && old('pic_name'))
                                                                <option value="{{ old('pic') }}" selected="selected">{{ old('pic_name') }}</option>
                                                            @endif
                                                        </select>
                                                        @if ($errors->has('pic'))
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            var oldValue = "{{ old('pic') }}";
                            if (oldValue) {
                                var oldName = "{{ old('pic_name') }}";
                                if (oldName) {
