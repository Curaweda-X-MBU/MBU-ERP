...
@section('content')
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{ route('data-master.location.add') }}">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" id="name" class="{{$errors->has('name')?'is-invalid':''}} form-control" name="name" placeholder="Nama Lokasi" value="{{ old('name') }}">
                                                        @if ($errors->has('name'))
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            var oldValue = "{{ old('area_id') }}";
                            if (oldValue) {
                                var oldName = "{{ old('area_name') }}";
                                if (oldName) {
