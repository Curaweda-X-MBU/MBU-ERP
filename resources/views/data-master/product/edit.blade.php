...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{ route('data-master.product.edit', $data->product_id) }}">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" id="sku" class="{{$errors->has('sku')?'is-invalid':''}} form-control" name="sku" placeholder="SKU" value="{{ $data->sku }}">
                                                        @if ($errors->has('sku'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <select name="product_category_id" id="product_category_id" class="form-control">
                                                            @if($data->product_category_id && ($data->product_category->name??false))
                                                                <option value="{{ $data->product_category_id }}" selected="selected">{{ $data->product_category_name??'' }}</option>
                                                            @endif
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <select name="product_sub_category_id" id="product_sub_category_id" class="form-control">
                                                            ...
                                                            @if($data->product_sub_category_id && ($data->product_sub_category->name??false))
                                                                <option value="{{ $data->product_sub_category_id }}" selected="selected">{{ $data->product_sub_category_name??'' }}</option>
                                                            @endif
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <select name="company_id" id="company_id" class="form-control">
                                                            @if($data->company_id && ($data->company_name??false))
                                                                <option value="{{ $data->company_id }}" selected="selected">{{ $data->company_name??'' }}</option>
                                                            @endif
                                                        </select>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="{{$errors->has('product_price')?'is-invalid':''}} form-control numeral-mask" placeholder="Harga Produk" name="product_price" aria-label="Harga Produk" aria-describedby="basic-addon1" value="{{$data->product_price}}">
                                                        </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="{{$errors->has('selling_price')?'is-invalid':''}} form-control numeral-mask" placeholder="Harga Jual" name="selling_price" aria-label="Harga" aria-describedby="basic-addon1" value="{{$data->selling_price}}">
                                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="input-group">
                                                            <input type="number" class="{{$errors->has('tax')?'is-invalid':''}} form-control" name="tax" placeholder="Pajak" aria-label="Pajak" aria-describedby="basic-addon2" value="{{$data->tax}}">
                                            ...
                                            <div class="col-12 mb-1" id="product-supplier-repeater">
                                                <div class="row" data-repeater-list="product_supplier">
                                                    <div class="col-sm-3">
                                                        <button class="btn btn-sm btn-primary float-right" type="button" data-repeater-create title="Tambah Vendor">
                                                            Tambar Vendor
                                                        </button>
                                                    </div>
                                                    <div class="col-sm-5 custom-supplier-repeater-grid" data-repeater-item>
                                                        ...
                                                        <div class="delete-button">
                                                            ...
                                                            <button class="btn btn-sm btn-icon btn-danger vertical-align-bottom" data-repeater-delete type="button" title="Hapus Produk">
                                                                <i data-feather="x"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="custom-control custom-switch custom-switch-primary" style="margin-top: 5px;">
                                                            <input type="checkbox" class="custom-control-input" id="canBeSold" name="can_be_sold" {{ $data->can_be_sold?'checked':'' }}>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="custom-control custom-switch custom-switch-primary" style="margin-top: 5px;">
                                                            <input type="checkbox" class="custom-control-input" id="canBePurchased" name="can_be_purchased" {{ $data->can_be_purchased?'checked':'' }}>
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            const suppliers = @js($data->suppliers);
                            suppliers.forEach((supplier, i) => {
                                $('[data-repeater-create]').trigger('click');
                                $(`select[name="product_supplier[${i}][supplier_id]"]`).append(`<option value="${supplier.supplier_id}" selected>${supplier.name}</option>`)
                                $(`input[name="product_supplier[${i}][product_price]"]`).val(supplier.pivot.product_price);
                            });
                            @endif
                            ...
                            var oldValue = "{{ $data->company_id }}";
                            if (oldValue) {
                                var oldName = "{{ $data->company->name??'' }}";
                                if (oldName) {
                            ...
                            var oldValueProductCategory = "{{ $data->product_category_id }}";
                            if (oldValueProductCategory) {
                                var oldNameProductCategory = "{{ $data->product_category->name??'' }}";
                            ...
                            var oldValueProductSubCategory = "{{ $data->product_sub_category_id }}";
                            if (oldValueProductSubCategory) {
                                var oldNameProductSubCategory = "{{ $data->product_sub_category->name??'' }}";
