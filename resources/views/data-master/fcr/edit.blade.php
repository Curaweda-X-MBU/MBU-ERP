                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="number" step="0.01" id="value" class="{{$errors->has('value')?'is-invalid':''}} form-control" name="value" placeholder="Nilai" value="{{ $data->value }}">
                                                        @if ($errors->has('value'))
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <select name="product_id" id="product_id" class="form-control">
                                                            @if($data->product_id && ($data->product->name??false))
