                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{ route('data-master.supplier.add') }}">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" id="name" class="{{$errors->has('name')?'is-invalid':''}} form-control" name="name" placeholder="Nama Pemasok" value="{{ old('name') }}">
                                                        @if ($errors->has('name'))
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" id="alias" class="{{$errors->has('alias')?'is-invalid':''}} form-control" name="alias" placeholder="Nama Alias" value="{{ old('alias') }}">
                                                        @if ($errors->has('alias'))
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" id="pic_name" class="{{$errors->has('pic_name')?'is-invalid':''}} form-control" name="pic_name" placeholder="Nama PIC" value="{{ old('pic_name') }}">
