                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{ route('data-master.product-component.add') }}">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="{{$errors->has('price')?'is-invalid':''}} form-control numeral-mask" placeholder="Harga" name="price" aria-label="Harga" aria-describedby="basic-addon1" value="{{old('price')}}">
                                                        </div>
                                                        @if ($errors->has('price'))
