                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" method="post" action="{{ route('data-master.product-category.add') }}">
                                        {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="text" id="category_code" class="{{$errors->has('category_code')?'is-invalid':''}} form-control" name="category_code" placeholder="Kode" value="{{ old('category_code') }}">
